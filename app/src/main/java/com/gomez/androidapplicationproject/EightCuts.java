...
public class EightCuts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eight_cuts);
        ...
        dataBaseHelper = new DataBaseHelper(EightCuts.this);
        ...
        try {
            ...
            InputStream in_s = res.openRawResource(R.raw.eightdiet);
        ...
        try {
            Resources res = getResources();
            InputStream in_s = res.openRawResource(R.raw.eightfeatures);
            byte[] b = new byte[in_s.available()];
            in_s.read(b);
        ...
        Uri eight_uri = Uri.parse("https://www.google.com/maps/dir/14.7402357,120.9601226/14.735088,120.96127/@14.7641401,120.9357467,12z");
        location = findViewById(R.id.txtLocation);

        location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent webLoc = new Intent(Intent.ACTION_VIEW, eight_uri);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Comment comment = new Comment(-1, com, i, "eight");
                ...
                Toast.makeText(EightCuts.this, "Comment Saved", Toast.LENGTH_SHORT).show();
            }
        });
   ...
   /* public void seeCommentSection()
    ...
    public int getLikeCounter()
    {
        ...
        Cursor data = dataBaseHelper.getLikeCount("'eight'");
    ...
    public int getDislikeCounter()
    {
        ...
        Cursor data = dataBaseHelper.getDislikeCount("'eight'");
